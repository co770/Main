...
export default function Index() {
  return (
    ...
    <View style={{flexDirection:'row',width:300,justifyContent:'space-between',borderBottomWidth:1,borderBottomColor:'black',marginBottom:20,alignItems:'center'}}>    <Ionicons name='home' size={22} color="orange"  style={{marginRight:20}}/>
    <TextInput placeholder="Username" style={{height:40,width:230}}/>
    <Ionicons name='home' size={22} color="orange"  style={{marginRight:20}}/>
    </View>
